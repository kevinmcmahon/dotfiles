...
description: Use for boundary design, dependency direction, and keeping business policy separate from technical detail.
---
...
- Source file: clean-architecture/clean-architecture.mini.md
