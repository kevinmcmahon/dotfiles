...
| `ai/skills/{common,codex}` | `~/.agents/skills/` | Dotfiles-owned Codex user skills generated by `scripts/ai-sync.sh` |
...
Dotfiles do not manage Codex user skills in `~/.codex/skills`; that directory
