...
| `claude/skills/` | `~/.claude/skills/` | Claude Code skill symlink farm generated from `ai/skills/{common,claude}` |
...
| `ai/skills/{common,codex}` | `~/.agents/skills/` | Codex user skills generated by `scripts/ai-sync.sh` |
